				...
				<div class="bg1">
					<div class="bg2">
						<div class="bg3">
							...
							<input type="button" name="button" value="show more" onClick = "input();"/>
 ...
 if(size == 1){%>
    ...
    var color = new Array();//d3.scale.category20()
        ...
        for(var k = 0; k < plotData.length; k++){
            color[k+7] = color[k].brighter(0.5);
        }
	...
	var node = g.selectAll("circle.node").data(randomData(), function (d) { return d.id; })
        ...
        .on("mouseover", function(){
                ...
                d3.selectAll("circle.node").filter(
                    function(d){return d.id == curid;}).attr("r", 15);
...
%>
            ...
            <div class="post">
				<div class="bg1">
					<div class="bg2">
						<div class="bg3">
							<h2 class="title">Subspace Ranking</h2>
							<div class="entry">
				...
				<li>
                    ...
                    <%
	                  ...
	                  for(int i = 0; i<sub_vis_attr.length; i++){
						  if(sub_vis_attr[i]){
                          %>
                                <form method="post" action="subtractvisattr.do">
		                      <% str = column_names.get(i);%>
                                    
                                    <input type="hidden" name="txt" value ="<%=i%>">
                                    <input type="submit" name="<%=str%>" value="-" />
                                    <a><%=str%></a>
                                    <br>
                                </form>
	                     <%}
              ...
              <li>
                    ...
                    <%				  
	                  ...
	                  for(int i = 0; i<sub_vis_attr.length; i++){
                          ...
                          %>
                                <form method="post" action="addvisattr.do">
		                      <% str = column_names.get(i);%>
